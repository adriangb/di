...
from anydep.models import DependencyProvider, Parameter
...
def is_gen_callable(call: DependencyProvider) -> bool:
...
def call_from_annotation(parameter: Parameter) -> DependencyProvider:
